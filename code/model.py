...
if __name__=='__main__':
    ...
    # getting_data = all_train_X
    #
    # getting_data.insert(25, 'y', 1)
    # getting_data.loc[0:500, 'y'] = 0
    # getting_data.loc[1000:1250, 'y'] = 0
    # getting_data.loc[3000:4250, 'y'] = 0
    # getting_data.loc[6000:8250, 'y'] = 0
    # getting_data.loc[10000:15500, 'y'] = 0
    # print(getting_data.shape)
    # getting_data.to_csv('pytestcases.csv')
    ...
    #result = GLM_Model.model(all_train_imputed_std['y'], all_train_X)
